...
def setup(bot:Bot):
    @bot.slash_command(name="quote_user", description="Quote a User",guild_ids=["1434128644220911709"])
    ...
    @bot.slash_command(name="quote", description="Quote Anything or Anyone",guild_ids=["1434128644220911709"])
    async def quote(
            ctx: discord.ApplicationContext,
            quote:str,
            quoter:str
    ...
    @bot.slash_command(name="test", description="Quote Anything or Anyone",guild_ids=["1434128644220911709"])
    async def test(
            ctx: discord.ApplicationContext,
        ):
